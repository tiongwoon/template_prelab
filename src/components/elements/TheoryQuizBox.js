...
export default function TheoryQuizBox() {
    ...
    function Answer(questionNumber) {
        ...
        const solutions = {
            ...
            working: [
                <div>
                    Using a streamline control volume, we eliminate the need to consider mass flow out via the side. But we need to define the radius of the streamline inlet.
                    We use mass balance to find. 
                    <MathJax.Context input='tex'>    
                        <MathJax.Node>{lineOne}</MathJax.Node>
                    </MathJax.Context>
                    <br></br>Using annular differential elements, the right hand side becomes<br></br>
                    <MathJax.Context input='tex'>    
                        <center> <MathJax.Node>{lineTwo}</MathJax.Node></center>
                    </MathJax.Context>
                    <br></br>We now have an expression for H. Then, we use momentum balance to find the drag force. Substituting the expression for H into the equation, we have
                    <MathJax.Context input='tex'>    
        ...
        <div>
            ...
            <div style={containerForQuizHeader}>
                ...
                &emsp; b. ME2 Fluid Mechanics 2 Tutorial Sheet 1 Question 3.
                    <br></br>
                    <br></br>
                    <a href="http://bb.imperial.ac.uk" target="_blank" rel="noopener noreferrer"><Button border="none" bg="#006EAF" color="#FFFFFF" _hover={{boxShadow:"0px 0px 25px 0px rgba(0,0,0,0.25)",bg:"#006EAF" ,cursor:"pointer"}}>Go to Blackboard</Button></a>
                    <br></br>
                    <br></br>
                    ...
                    <Collapse isOpen={showHint} marginTop= "0.7em" >
                        This question is similar to question 1. The only difference here is that data is given for the velocity. So, you need to think of a way to find the integral, or in other words, the sum. 
                    </Collapse>
                    {answerOne ? Answer(1) : null}
                    <br></br>
                    <br></br>
                3. Given that the object has a radius of 28mm, using the drag force calculated from question 2, work out the drag coefficient, <MathJax.Context input='tex'><MathJax.Node inline>{dragCoefficient}</MathJax.Node></MathJax.Context>.
