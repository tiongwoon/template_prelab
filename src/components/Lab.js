...
const equipment = {
  ...
  equipmentImage: [
    "",
    <img className="equipmentImage" src={require("../assets/pitot.jpg")} />,
    <img className="equipmentImage" src={require("../assets/manometer.jpg")} />,
    <img
      className="equipmentImage"
    ...
    />,
    <img className="equipmentImage" src={require("../assets/object.jpg")} />,
  ],
