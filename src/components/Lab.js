...
const equipment = {
  ...
  equipmentImage: [
    "",
    <img className="equipmentImage" src={require("../assets/pitot.jpg")} alt="A pitot tube." />,
    <img className="equipmentImage" src={require("../assets/manometer.jpg")} alt="A manometer" />,
    <img
      className="equipmentImage"
    ...
    />,
    <img className="equipmentImage" src={require("../assets/object.jpg")} alt="The object, which is a round flat disc." />,
  ],
